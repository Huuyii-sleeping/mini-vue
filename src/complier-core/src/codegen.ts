...
import { CREATE_ELEMENT_VNODE, helperMapName, TO_DISPLAT_STRING } from "./runtimeHelpers"
...
function genElement(node, context) {
    ...
    console.log('tag:',tag,'children:',children,'props:',props)
